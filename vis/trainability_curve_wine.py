...
results = [
    'GD_200_0_0-wine.npy',
    'GD_200_5e-5_0-wine.npy',
    # 'GD_200_0_10-wine.npy',
    'GD_4_0_0-wine.npy',
    'GD_4_5e-5_0-wine.npy',
    # 'GD_4_0_10-wine.npy',
    'GD_4_0_0_noisy-wine.npy',
    'NGD_4_0_0-wine.npy'
]
...
fig, ax = plt.subplots(1, 2, sharex='col', sharey='row', figsize=(10.08, 6.0))
lines, lines_label = [], []
x = range(0, 100, 10)
...
plt.savefig('figure/net_generalization_wine.pdf', dpi=600, format='pdf')
plt.show()
plt.clf()